...
# labels
#label(alldata$MeanHeartRate)="Mean HR (bpm)"

myvars <- c("C_Ap","C_Ph","C_Agph","MeanHeartRate","MeanPulseWaveVelocity","BA_Distensibilty","cIMT")
...
The CVD outcomes data were provided to the blinded statistician, along with blinded group memberships.  Participants with at least one CVD measure were included in this report.  Participants were stratified by group and descriptive statistics were calculated.
...
kableone(tab,caption="Table 1.  Descriptive statistics for CVD measures, by blinded study group.  Statistics given are mean±SD.")
```
